...
DATASET_NAME = 'yellowtail_multi_2_cam3_test_ground_truth'
...
fm = KITTI_folder_manager(data_dir=DATASET_DIR,name=DATASET_NAME)
fm.create_folder()

kitti_dataset = KITTI_Dataset()
kitti_dataset.load_from_opencv(opencv_dataset,fm)

kitti_dataset.save_image()
kitti_dataset.save_camera()
kitti_dataset.save_ann()
